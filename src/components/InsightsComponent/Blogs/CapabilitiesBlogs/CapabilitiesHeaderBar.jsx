...
const CapabilitiesHeaderBar = ({ onBlogChange }) => {
  ...
  useEffect(() => {
    ...
    return () =>
      scrollEl.removeEventListener("scroll", handleScrollVisibility);
  }, []);
  ...
  return (
    <div className="px-4 md:px-10 lg:px-20 relative">
      <div className="flex  md:flex-row items-start md:items-center justify-between relative">
        ...
        {/* Tabs Scrollable */}
        <div
          className="overflow-x-hidden  hidden md:block"
          ref={scrollRef}
        >
        ...
        {showRight && (
          <button
            className="absolute right-56 top-2 z-10 bg-white shadow p-1 rounded-full"
...
export default CapabilitiesHeaderBar;
