...
const CapabilitiesHelpClient = ({ name = "Automotive", capability }) => {
        ...
        {cardData.map(({ id, img }) => (
          ...
          >
            ...
            <div className="p-4 flex-grow">
              <h2 className="text-md font-semibold capitalize">{capability}</h2>
...
export default CapabilitiesHelpClient;
