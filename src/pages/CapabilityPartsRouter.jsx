...
// import SustainabilityPartsRouter from "../../components/CapabilitiesComponent/SustainabilityDetail/SustainabilityParts/SustainabilityPartsRouter";
...
const CapabilityPartsRouter = () => {
 const { capability, slug } = useParams();
  ...
  switch (capability) {
    ...
    // Uncomment these only when their files exist
    ...
    //   return <SustainabilityPartsRouter slug={slug} />;
